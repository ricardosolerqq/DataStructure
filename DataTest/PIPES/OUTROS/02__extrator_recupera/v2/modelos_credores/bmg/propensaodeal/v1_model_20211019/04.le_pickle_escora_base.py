...
dbutils.widgets.text('credor', 'bmg')
credor = dbutils.widgets.get('credor')
credor = Credor(credor)

dbutils.widgets.text('modelo_escolhido', 'v1_model_20211019')
...
list_var = [chave, 'ind_sexo', 'cod_credor', 'des_estad_comer', 'val_renda', 'des_cep_resid', 'tip_ender_corre', 'des_fones_resid', 'des_uf_rg', 'qtd_prest', 'val_compr', 'cod_filia', 'cod_profi_clien']
...
base_dados['cod_filia'] = base_dados['cod_filia'].astype(np.int64)
base_dados['cod_profi_clien'] = base_dados['cod_profi_clien'].astype(np.int64)
...
#base_dados['des_fones_resid'] = base_dados['des_fones_resid'].fillna(1)
#base_dados['des_fones_resid'] = base_dados['des_fones_resid'].replace(0, 1)
#-base_dados['des_fones_resid'] = pd.to_numeric(base_dados['des_fones_resid'], errors = 'coerce')

# COMMAND ----------

#-base_dados['cod_profi_clien'] = pd.to_numeric(base_dados['cod_profi_clien'], errors = 'coerce')
...
base_dados['des_fones_resid__L__p_3_g_1_c1_3_1'] = np.where(np.bitwise_and(base_dados['des_fones_resid__L__p_3_g_1'] == 0, base_dados['des_fones_resid__L__pe_6_g_1'] == 0), 0,
    ...
    np.where(np.bitwise_and(base_dados['des_fones_resid__L__p_3_g_1'] == 0, base_dados['des_fones_resid__L__pe_6_g_1'] == 2), 1,
    np.where(np.bitwise_and(base_dados['des_fones_resid__L__p_3_g_1'] == 1, base_dados['des_fones_resid__L__pe_6_g_1'] == 0), 1,
...
base_dados['cod_profi_clien__T__p_34_g_1_c1_4_1'] = np.where(np.bitwise_and(base_dados['cod_profi_clien__p_2_g_1'] == 0, base_dados['cod_profi_clien__T__p_34_g_1'] == 0), 0,
    ...
    np.where(np.bitwise_and(base_dados['cod_profi_clien__p_2_g_1'] == 1, base_dados['cod_profi_clien__T__p_34_g_1'] == 1), 1,
     0))))
...
varvar=[]
varvar= [chave,'cod_credor_gh38','des_estad_comer_gh38','val_renda__C__pe_5_g_1_c1_24','raiz_cep__L__p_13_g_1_c1_25','tip_ender_corre_gh38','des_fones_resid__L__p_3_g_1_c1_3','des_uf_rg_gh38','qtd_prest__pe_6_g_1_c1_11','ind_sexo_gh38','val_compr__T__p_13_g_1_c1_6','cod_filia_gh38','cod_profi_clien__T__p_34_g_1_c1_4']
...
modelo = os.listdir(os.path.join(credor.caminho_pickle_dbfs,modelo_escolhido))[0]
print (modelo)
modelo = pickle.load(open(os.path.join(credor.caminho_pickle_dbfs, modelo_escolhido, modelo), 'rb'))
...
x_teste2['GH'] = np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 0, x_teste2['P_1_R_p_15_g_1'] == 0), 0,
    ...
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 0, x_teste2['P_1_R_p_15_g_1'] == 2), 1,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 0, x_teste2['P_1_R_p_15_g_1'] == 3), 1,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 0, x_teste2['P_1_R_p_15_g_1'] == 4), 2,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 0, x_teste2['P_1_R_p_15_g_1'] == 5), 2,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 0, x_teste2['P_1_R_p_15_g_1'] == 6), 3,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 0, x_teste2['P_1_R_p_15_g_1'] == 7), 3,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 0, x_teste2['P_1_R_p_15_g_1'] == 8), 4,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 0, x_teste2['P_1_R_p_15_g_1'] == 9), 4,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 1, x_teste2['P_1_R_p_15_g_1'] == 0), 2,
    ...
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 1, x_teste2['P_1_R_p_15_g_1'] == 4), 4,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 1, x_teste2['P_1_R_p_15_g_1'] == 5), 4,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 1, x_teste2['P_1_R_p_15_g_1'] == 6), 5,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 1, x_teste2['P_1_R_p_15_g_1'] == 7), 5,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 1, x_teste2['P_1_R_p_15_g_1'] == 8), 6,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 1, x_teste2['P_1_R_p_15_g_1'] == 9), 6,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 2, x_teste2['P_1_R_p_15_g_1'] == 0), 2,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 2, x_teste2['P_1_R_p_15_g_1'] == 1), 3,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 2, x_teste2['P_1_R_p_15_g_1'] == 2), 4,
    ...
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 2, x_teste2['P_1_R_p_15_g_1'] == 5), 4,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 2, x_teste2['P_1_R_p_15_g_1'] == 6), 5,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 2, x_teste2['P_1_R_p_15_g_1'] == 7), 5,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 2, x_teste2['P_1_R_p_15_g_1'] == 8), 6,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 2, x_teste2['P_1_R_p_15_g_1'] == 9), 7,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 3, x_teste2['P_1_R_p_15_g_1'] == 0), 3,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 3, x_teste2['P_1_R_p_15_g_1'] == 1), 3,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 3, x_teste2['P_1_R_p_15_g_1'] == 2), 4,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 3, x_teste2['P_1_R_p_15_g_1'] == 3), 4,
    ...
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 3, x_teste2['P_1_R_p_15_g_1'] == 6), 5,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 3, x_teste2['P_1_R_p_15_g_1'] == 7), 6,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 3, x_teste2['P_1_R_p_15_g_1'] == 8), 6,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 3, x_teste2['P_1_R_p_15_g_1'] == 9), 7,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 4, x_teste2['P_1_R_p_15_g_1'] == 0), 3,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 4, x_teste2['P_1_R_p_15_g_1'] == 1), 3,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 4, x_teste2['P_1_R_p_15_g_1'] == 2), 4,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 4, x_teste2['P_1_R_p_15_g_1'] == 3), 4,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 4, x_teste2['P_1_R_p_15_g_1'] == 4), 5,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 4, x_teste2['P_1_R_p_15_g_1'] == 5), 5,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 4, x_teste2['P_1_R_p_15_g_1'] == 6), 6,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 4, x_teste2['P_1_R_p_15_g_1'] == 7), 6,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 4, x_teste2['P_1_R_p_15_g_1'] == 8), 7,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 4, x_teste2['P_1_R_p_15_g_1'] == 9), 7,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 5, x_teste2['P_1_R_p_15_g_1'] == 0), 4,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 5, x_teste2['P_1_R_p_15_g_1'] == 1), 4,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 5, x_teste2['P_1_R_p_15_g_1'] == 2), 5,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 5, x_teste2['P_1_R_p_15_g_1'] == 3), 5,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 5, x_teste2['P_1_R_p_15_g_1'] == 4), 6,
    ...
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 5, x_teste2['P_1_R_p_15_g_1'] == 7), 7,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 5, x_teste2['P_1_R_p_15_g_1'] == 8), 7,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 5, x_teste2['P_1_R_p_15_g_1'] == 9), 8,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 6, x_teste2['P_1_R_p_15_g_1'] == 0), 4,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 6, x_teste2['P_1_R_p_15_g_1'] == 1), 4,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 6, x_teste2['P_1_R_p_15_g_1'] == 2), 5,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 6, x_teste2['P_1_R_p_15_g_1'] == 3), 5,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 6, x_teste2['P_1_R_p_15_g_1'] == 4), 6,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 6, x_teste2['P_1_R_p_15_g_1'] == 5), 6,
    ...
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 6, x_teste2['P_1_R_p_15_g_1'] == 9), 8,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 7, x_teste2['P_1_R_p_15_g_1'] == 0), 3,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 7, x_teste2['P_1_R_p_15_g_1'] == 1), 4,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 7, x_teste2['P_1_R_p_15_g_1'] == 2), 4,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 7, x_teste2['P_1_R_p_15_g_1'] == 3), 5,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 7, x_teste2['P_1_R_p_15_g_1'] == 4), 5,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 7, x_teste2['P_1_R_p_15_g_1'] == 5), 6,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 7, x_teste2['P_1_R_p_15_g_1'] == 6), 7,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 7, x_teste2['P_1_R_p_15_g_1'] == 7), 7,
    ...
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 8, x_teste2['P_1_R_p_15_g_1'] == 0), 5,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 8, x_teste2['P_1_R_p_15_g_1'] == 1), 5,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 8, x_teste2['P_1_R_p_15_g_1'] == 2), 6,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 8, x_teste2['P_1_R_p_15_g_1'] == 3), 6,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 8, x_teste2['P_1_R_p_15_g_1'] == 4), 7,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 8, x_teste2['P_1_R_p_15_g_1'] == 5), 7,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 8, x_teste2['P_1_R_p_15_g_1'] == 6), 8,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 8, x_teste2['P_1_R_p_15_g_1'] == 7), 8,
    np.where(np.bitwise_and(x_teste2['P_1_pe_10_g_1'] == 8, x_teste2['P_1_R_p_15_g_1'] == 8), 9,
...
df_a_escrever = x_teste2[['DOCUMENTO', 'P_1', 'GH']]
df_a_escrever['GH'].value_counts()
...
df_a_escrever.to_parquet(os.path.join(credor.caminho_pre_output_dbfs, 'pre_output_'+data+'.PARQUET'))
