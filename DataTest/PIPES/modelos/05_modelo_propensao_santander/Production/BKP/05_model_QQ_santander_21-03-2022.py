...
sparkDF.write.option("sep",";").option("header","true").option("mode","overwrite").csv(sink)

# COMMAND ----------

dbutils.fs.ls('/dbfs/mnt/etlsantander/Base_UFPEL/Dados=2021-11-05/score_model/')
...
sparkDF.write.option("sep",";").option("header","true").option("mode","overwrite").csv(sinkHomomgeneous)
