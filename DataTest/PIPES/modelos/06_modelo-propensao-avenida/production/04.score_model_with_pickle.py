...
base_path = '/dbfs/mnt/ml-prd/ml-data/propensaodeal/avenida/trusted'
folderlist = {}
for folder in os.listdir(base_path):
  folderlist.update({int(folder.replace('-','')):folder})
max_folder = folderlist[max(list(folderlist))]
max_folder_path = os.path.join('/dbfs/mnt/ml-prd/ml-data/propensaodeal/avenida/trusted', max_folder)
max_folder
...
N_Base = "trustedFile_avenida.csv"

#Caminho da base de dados
caminho_base = max_folder_path
...
caminho_pickle = "/dbfs/mnt/ml-prd/ml-data/propensaodeal/avenida/pickle_model/v1_model_20211209/model_fit_avenida.sav"
outputpath = '/mnt/ml-prd/ml-data/propensaodeal/avenida/output'
outputpath_dbfs = '/dbfs/mnt/ml-prd/ml-data/propensaodeal/avenida/output'
...
os.path.join(caminho_base,N_Base)
...
import pickle
modelo=pickle.load(open(caminho_pickle, 'rb'))
...
x_teste2.to_csv(open(os.path.join(outputpath_dbfs, 'pre_output:'+max_folder.replace('-','')+'.csv'),'wb'))
os.path.join(outputpath_dbfs, 'pre_output:'+max_folder.replace('-','')+'.csv')