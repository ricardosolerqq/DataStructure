...
N_Base = "colombo_full.csv"

#Caminho da base de dados
caminho_base = '/mnt/ml-prd/ml-data/propensaodeal/colombo/trusted/'
...
caminho_pickle = '/dbfs/mnt/ml-prd/ml-data/propensaodeal/colombo/pickle_model'

model = 'v1_model_20220111'

caminho_output = '/dbfs/mnt/ml-prd/ml-data/propensaodeal/colombo/output'
...
caminho_arquivo = '/dbfs'+os.path.join(caminho_base, folder_a_processar, 'colombo_full.csv')
...
os.path.join(caminho_output, nome_escrito)