...
outputpickle = '/mnt/ml-prd/ml-data/propensaodeal/credz/pickle_model/2021-08-28/'
...
N_Base = "sample_modelo_credz.csv"

#Caminho da base de dados
caminho_base = "/dbfs/mnt/ml-prd/ml-data/propensaodeal/credz/base_treino_modelo_elisvaldo/"
...
varvar=[]
varvar= [chave,target,'TIPO_TELEFONE_3_gh38','DETALHES_CONTRATOS_HISTORICO_FPD_gh38','AGING__p_7_g_1_c1_17','DETALHES_DIVIDAS_VALOR_JUROS__pe_3_g_1_c1_3','DETALHES_CONTRATOS_BLOQUEIO1_DESC_gh3810_gh29','ATRASO_DETALHES_CLIENTES_VENCIMENTO_FATURA_gh382_gh29','DETALHES_CONTRATOS_BLOQUEIO2_gh38','TIPO_TELEFONE_0_gh3814_gh29']
base_final = base_dados[varvar]
base_final
...
base_teste_c0 = base_final

var_fin_c0=list(base_final.columns)
...
pickle.dump(modelo,open('/dbfs/'+outputpickle+'modelo_credz_diego_elisvaldo.sav','wb'))