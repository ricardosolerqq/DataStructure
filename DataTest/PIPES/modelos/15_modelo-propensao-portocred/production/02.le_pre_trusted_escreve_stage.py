...
parquetfilepath = '/mnt/ml-prd/ml-data/propensaodeal/portocred/pre-trusted'
parquetfilepath_dbfs = '/dbfs/mnt/ml-prd/ml-data/propensaodeal/portocred/pre-trusted'

writepath_stage = '/mnt/ml-prd/ml-data/propensaodeal/portocred/stage'
